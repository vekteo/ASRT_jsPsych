const en = {
    ...
    instruction: {
        fourCircles: "In this task, you will see four circles on the screen. From left to right, the <strong>'S'</strong>, <strong>'F'</strong>, <strong>'J'</strong> and <strong>'L'</strong> keys correspond to the four circles.",
    ...
    instruction2: {
        ...
        secondButton: "the <strong>'F'</strong> key with the index finger of your left hand</strong>",
        thirdButton: "the <strong>'J'</strong> key with the index finger of your right hand,",
        fourthButton: "the <strong>'L'</strong> key with the middle finger of your right hand</strong>.",
    ...
    feedback: {
        ...
        yourRt: "Your average response time: ",
        moreAccurate: "Try to be more accurate!",
        faster: "Try to be faster!",
        continue: "Nice job!"
    },
    button: {
        next: "Next",
...
const hu = {
    ...
    instruction: {
        fourCircles: "Ebben a feladatban négy kört fogsz látni a képernyő közepén. Balról jobbra az <strong>'S'</strong>, <strong>'F'</strong>, <strong>'J'</strong> és <strong>'L'</strong> billentyűk tartoznak a négy körhöz.",
    ...
    instruction2: {
        ...
        secondButton: "az <strong>'F'</strong> billentyűt a bal kezed mutatóujjával,</strong>",
        thirdButton: "a <strong>'J'</strong> billentyűt a jobb kezed mutatóujjával,",
        fourthButton: "az <strong>'L'</strong> billentyűt pedig a jobb kezed középsőujjával </strong>kell lenyomni.",
    ...
    feedback: {
        ...
        yourAccuracy: "Az átlagos pontosságod: ",
        yourRt: "Az átlagos reakcióidőd: ",
        moreAccurate: "Kérlek, próbálj meg pontosabb lenni!",
        faster: "Kérlek, próbálj meg gyorsabb lenni!",
        continue: "Szép munka!"
    },
    button: {
        next: "Tovább",
...
const fr = {
    ...
    instruction: {
        fourCircles: "Dans cette tâche, vous verrez quatre cercles à l'écran. De gauche à droite, les touches <strong>'S'</strong>, <strong>'F'</strong>, <strong>'J'</strong> et <strong>'L'</strong> correspondent aux quatre cercles.",
    ...
    instruction2: {
        ...
        secondButton: "la touche <strong>'F'</strong> avec l'index de votre main gauche</strong>.",
        thirdButton: "La touche <strong>'J'</strong> avec l'index de votre main droite,",
        fourthButton: "la touche <strong>'L'</strong> avec le majeur de votre main droite</strong>",
    ...
    feedback: {
        ...
        yourAccuracy: "Votre précision: ",
        yourRt: "Votre temps de réponse moyen: ",
        moreAccurate: "Essayez d'être plus précis!",
        faster: "Essayez d'aller plus vite!",
        continue: "Bien joué!"
    },
    button: {
        next: "Suivant",
...
const pt = {
    ...
    instruction: {
        fourCircles: "Nessa tarefa, você verá quatro círculos na tela. Da esquerda para a direita, as teclas <strong>'S'</strong>, <strong>'F'</strong>, <strong>'J'</strong> e <strong>'L'</strong> correspondem aos quatro círculos.",
    ...
    instruction2: {
        ...
        secondButton: "a tecla <strong>'F'</strong> com o dedo indicador da sua mão esquerda</strong>",
        thirdButton: "a tecla <strong>'J'</strong> com o dedo indicador da sua mão direita,",
        fourthButton: "a tecla <strong>'L'</strong> com o dedo do meio da sua mão direita</strong>.",
    ...
    feedback: {
        ...
        yourAccuracy: "Sua precisão: ",
        yourRt: "Seu tempo de resposta médio: ",
        moreAccurate: "Tente ser mais preciso!",
        faster: "Tente ser mais rápido!",
